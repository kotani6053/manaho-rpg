...
export default function GamePage() {
  const [score, setScore] = useState(100); // 初期スコアを少し持たせます
      ...
      <div className="w-full max-w-6xl h-full max-h-[95vh] bg-slate-100 rounded-[2rem] border-[6px] border-[#222222] p-6 shadow-[0_10px_0_#000] flex flex-col gap-6">
        ...
        <header className="flex justify-between items-center bg-white border-4 border-[#222222] rounded-2xl p-4 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <button className="bg-pink-500 border-4 border-[#222222] px-6 py-2 rounded-xl font-black text-white">🎰 ガチャ</button>
            <div className="bg-amber-400 border-4 border-[#222222] px-6 py-2 rounded-xl font-black text-lg">スコア: {score}</div>
          </div>
        </header>
